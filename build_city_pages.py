...
NYC_SEO_NAV = """<nav class="seo-nav" aria-label="Browse rent-stabilized buildings by neighborhood">
  ...
  <p>Find A Crib maps every DHCR-registered rent-stabilized building in New York City.
     ...
     See which stabilized buildings have an apartment listed for
     <a href="/section8/">Section 8 and other voucher holders right now</a>, rebuilt daily from
     the overnight AffordableHousing.com feed, or read the
     <a href="/brief/">daily briefs</a> on what came on and off the market.
     Compare
     <a href="/council-district/">rent-stabilized housing and open HPD violations by City Council district</a>.
  ...
  <!-- The provenance page, linked from the one page on this site Google has
       ever indexed. Every generated page footers it too, but a link from the
       homepage puts it one click from the root instead of one click from a tier
       that is itself not indexed. -->
  <p>Every building here comes from a public register.
     <a href="/methodology/">See where the data comes from, how often it changes, and what each
     city's list does not prove</a>.</p>
