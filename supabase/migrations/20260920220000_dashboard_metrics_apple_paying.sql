-- Paying / MRR counted only Stripe rows; an App Store subscriber (provider
-- 'apple', no stripe_subscription_id) never showed. Two real ones from
-- 2026-09-09/10 were invisible (2026-09-20). Live definition via pg_get_functiondef.
